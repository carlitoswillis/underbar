(function() {
  ...
  _.last = function(array, n) {
    return n > array.length ? array.slice() : n === undefined ? array[array.length-1] : array.slice(array.length - n);
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    if (accumulator !== undefined) {
      ...
      for (var key in collection) {
        ...
        accumulation = iterator(accumulation, Array.isArray(collection) ? collection[Number(key)] : collection[key]);
      }
  ...
  _.extend = function(obj) {
    ...
    for (var i = 1; i < arguments.length; i++) {
      newKeys = Object.keys(arguments[i]);
      if (newKeys.length === 0) {
        return obj;
      }
  ...
  _.delay = function(func, wait) {
    ...
    var restArguments = Array.prototype.slice.call(arguments).slice(2);
